...
class SPort
{
    private static List<byte> rcvbytes = new List<byte>(); //수신버퍼의 오는 데이터(바이트)들을 저장하기 위한 리스트
    ...
    public static void SendUnicode(SerialPort sport, string text) //한글을 보낼 때 사용
    {
